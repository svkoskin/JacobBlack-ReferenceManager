...
<html>
    ...
    <body>
        ...
        <form:form commandName="viite" action="${action}" method="POST" class="form">
            ...
            <p><form:input path="publisher" /><label>*Publisher</label><form:errors path="publisher" cssClass="error" /></p>
            ...
            <p><form:input path="series" /><label>Series</label><form:errors path="series" cssClass="error" /></p>
            <p><form:input path="edition" /><label>Edition: </label><form:errors path="edition" cssClass="error" /></p>
